                  ...
                  <tr key={issue._id || index} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-center">
                      {issue.image_url || issue.imageUrl ? (
                        <button
                          onClick={() => handleImageClick(issue)}
            ...
            <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <button
                  ...
                  className={`flex items-center space-x-1 px-3 py-1 text-sm ${currentPage === 1
                ...
                <button
                  ...
                  className={`flex items-center space-x-1 px-3 py-1 text-sm ${currentPage === totalPages
                      ? 'text-gray-400 cursor-not-allowed'
                      : 'text-[#3A364F] hover:text-[#3A3646]'
                    } transition-colors`}
                >
